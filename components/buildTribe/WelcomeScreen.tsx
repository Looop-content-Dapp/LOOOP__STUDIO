import TribesInfoModal from '@/components/modal/TribesInfoModal';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={[styles.textContainer, dynamicStyles.contentContainer]}>
          <Text style={[styles.title, dynamicStyles.title]}>Welcome to tribes</Text>
      ...
      <TribesInfoModal visible={modalVisible} onClose={handleCloseModal} onNext={onNext} />
    </SafeAreaView>
  );
};
